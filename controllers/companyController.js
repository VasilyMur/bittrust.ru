...
exports.getCompaniesTagOnly = async (req, res) => {
  try {
    ...
    if (tagOriginal === 'remont-asikov') {
      ...
      description = 'Все компании, которые производят ремонт асиков и другого оборудования для майнинга - адреса на карте, отзывы и рейтинг. Хотите отремонтировать сломанный майнер у профессионалов? Вам сюда! Оставьте свой отзыв о конторе – и помогите ближнему.';
      ...
      description = 'Все компании, которые продают асики и другое оборудование для майнинга - адреса на карте, отзывы и рейтинг. Хотите узнать, где можно купить асик или ферму для майнинга криптовалют и не стать жертвой мошенников? Вам сюда! Наши рейтинги основаны на ваших оценках.';
      ...
      description = 'Все компании где можно разместить оборудование для майнинга в дата центрах - на карте с отзывами и рейтингом! Хотите найти помещение под майнинг? Хотите вывести шумные асики из дома в профессиональный майнинг отель? Наши обзоры помогут найти надежную компанию!';
    };
